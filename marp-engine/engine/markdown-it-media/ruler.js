...
const { default: Token } = require("markdown-it/lib/token.mjs");


const { parseMedia } = require("./parse.js");
const { getMediaType } = require("./media-type.js");
...
function pushMediaToken(state, media, options) {
  ...
  if (!mediaType || mediaType === "image") {
		// i dont want it to parse image tokens
		return false;
