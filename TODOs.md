...
- [ ] it doesnt add the column stacks that are used to create new stacks when dropping columns on it in the second row or later. it only creates them on the first row.
