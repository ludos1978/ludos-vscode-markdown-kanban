...
class TagUtils {
    constructor() {
        ...
        // Date locale configuration (default: de-DE for European DD.MM.YYYY format)
    ...
    /**
     * Extract date tag from text with strict locale-based parsing
    ...
    extractDateTag(text) {
        ...
        if (parts.length === 2) {
            ...
            // 3 parts - determine format based on which part has 4 digits
