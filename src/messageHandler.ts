...
export class MessageHandler {
    ...
    private _initializeCommandRegistry(): void {
        ...
        this._commandContext = {
            ...
            setUndoRedoOperation: (isOperation: boolean) => this._deps.getWebviewPanel()?.setUndoRedoOperation(isOperation),
            getWebviewPanel: this._deps.getWebviewPanel,
            getWebviewBridge: () => this._deps.getWebviewBridge?.() ?? this._deps.getWebviewPanel()?.getWebviewBridge?.(),
