...
- `src/html/webview.js` updateColumnContent handler now logs cache/column state, render decisions, and requests board refresh if cached board is missing or out of sync.
