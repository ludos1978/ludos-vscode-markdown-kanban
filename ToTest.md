...
- [ ] In WYSIWYG, clicking the left/right half of an image block places the cursor before/after it without removing the image.
- [ ] In WYSIWYG, typing while an image block is selected inserts text after the image (no replacement).
