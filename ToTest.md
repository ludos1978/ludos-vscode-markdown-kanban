...
- [ ] On keyboard layouts where ~ is a dead key (e.g., Alt+N then Space), confirm ~ inserts normally with no selection and wraps selected text when pressed with a selection.
