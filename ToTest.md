...
- [ ] In WYSIWYG, mermaid/plantuml blocks show clear ```lang ... ``` boundaries while editing, and the Edit button overlays the diagram at the top-left (not over the code text).
