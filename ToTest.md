...
- [ ] In WYSIWYG, mermaid/plantuml blocks show clear ```lang ... ``` boundaries while editing, the burger menu includes the Edit action (no standalone Edit button), and the preview height is fixed only while editing.
